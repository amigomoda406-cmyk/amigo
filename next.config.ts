      ...
      // ── الأمان: لكل الصفحات والـ API ─────────────────────────────────────
      {
        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(), payment=()' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.sanity.io https://static.cloudflareinsights.com https://connect.facebook.net",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com data:",
              "img-src 'self' data: https://cdn.sanity.io https://lh3.googleusercontent.com blob: https://www.facebook.com",
              "connect-src 'self' https://*.sanity.io https://*.supabase.co https://api.telegram.org https://*.upstash.io https://cloudflareinsights.com https://www.facebook.com",
